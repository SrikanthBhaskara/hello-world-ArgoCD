# Linux Interview Questions: Beginner to 6 Years

## Purpose

This note set organizes Linux interview preparation by experience level using the Linux notes in this folder as the source baseline.

## Files

- [Linux deep notes](./linux-deep-notes.md)
- [Linux interview questions with short and better answers](./linux-interview-questions-with-short-and-better-answers.md)
- [Linux troubleshooting scenarios with ideal answers](./linux-troubleshooting-scenarios-with-ideal-answers.md)
- [Linux command and shell scripting interview examples](./linux-command-and-shell-scripting-interview-examples.md)
...
- `linux-interview-questions-experienced-4-to-6-years.md`

## Recommended Study Order

1. Linux basics: shell, filesystem, users, permissions, processes, networking
2. Sysadmin depth: package management, storage, services, logging, backups
3. DevOps depth: Docker, Kubernetes basics, Git, automation, monitoring
